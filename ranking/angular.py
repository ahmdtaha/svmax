...
if __name__ == '__main__':
    _input_labels = tf.constant([1,2],tf.int32)
    _anchor_features = tf.constant([[1,0],[1,0]],tf.float32)
    _pos_features = tf.constant([[-1, 0], [-1, 0]],tf.float32)

    print(angular_loss(_input_labels,_anchor_features,_pos_features,batch_size=2))
